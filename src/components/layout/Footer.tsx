...
export default function Footer() {
  ...
  // 社交媒体链接
  const socialLinks = [
    { name: '个人网站', url: resumeData.website, icon: 'globe' },
    { name: 'GitHub', url: resumeData.github, icon: 'github' },
    { name: 'LinkedIn', url: resumeData.linkedin, icon: 'linkedin' }
  ];
  ...
  return (
    <footer className="bg-gray-900 py-12">
      <div className="container mx-auto px-4">
        ...
        >
          <p>© {currentYear} {resumeData.name}. 保留所有权利。</p>
        </motion.div>
      </div>
    </footer>
  );
